...
function xacnhan(event){
	...
	var matkhau = document.getElementById("matkhau");
		...
		if ( giatriemail == "" || giatrimatkhau == "" || !kiemTraEmail(giatriemail) || giatrimatkhau.length < 8) {
			return false;
		}
		else{
			return true;
...
function xacnhandangky(event){
	...
	var giatrimatkhaudangky = document.getElementById("matkhaudangky").value.trim();
	var giatrimatkhaudangkynhaplai = document.getElementById("matkhaudangkynhaplai").value.trim();
	...
	var matkhaudangkynhaplai = document.getElementById("matkhaudangkynhaplai");
		...
		if ( giatriemaildangky == "" || giatrimatkhaudangky == "" || !kiemTraEmail(giatriemaildangky) || giatrimatkhaudangky.length < 8 ||
			giatritendangky == "" || giatrimatkhaudangkynhaplai == "" || giatrimatkhaudangkynhaplai.length < 8 ) {
			return false;
		}
		else{
			return true;
